...
contract Secret_HoneyDex is ChainlinkClient{
    ...
    bytes32[] public encryptedInvoices;
    ...
    constructor(
        ...
        encryptedInvoices = _encryptedInvoices;
    ...
    function getpublicKeys() public view returns(bytes32[]) {
        return publicKeys;
    }

    function getencryptedInvoices() public view returns(bytes32[]) {
        return encryptedInvoices;
    }
