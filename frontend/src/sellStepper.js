...
import CreateHoneyDex from "views/Components/CreateContract.js";
import InteractContract from "views/Components/InteractContract.js";
...
function getSteps() {
  return ["Create agreement", "Fuel contract", "Interacting with buyer"];
}

function getStepContent(step,handleChange) {
  switch (step) {
   case 0:
      return <div><CreateHoneyDex createHandler={onContractCreation} toggleNextEnabled={handleChange}/></div>;
    case 1:
      return <div><InteractContract newHoneyDexAddress={newHoneyDexAddress} newOracleCount={newOracleCount}/></div>;
    case 2:
